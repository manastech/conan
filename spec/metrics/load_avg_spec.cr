...
describe "load_avg" do
  it "parses mac uptime" do
    values = collect(LoadAvgTest.new("16:06  up 4 days,  5:19, 6 users, load averages: 1.20 1.79 1.77"))
  ...
  it "parses linux uptime" do
    values = collect(LoadAvgTest.new(" 16:12:22 up 41 days,  1:24,  2 users,  load average: 0.02, 0.04, 0.05"))
